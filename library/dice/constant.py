...
LongInsanity = [
    ...
    (
        "恐惧：调查员患上一个新的恐惧症。调查员会在{dur}小时后恢复正常，"
        "并开始为避开恐惧源而采取任何措施。\n"
        "{detail_roll}\n"
        "具体恐惧症: {detail}(守秘人也可以自行从恐惧症状表中选择其他症状)"
    ),
    (
        "躁狂：调查员患上一个新的躁狂症，在{dur}小时后恢复理智。"
        "在这次疯狂发作中，调查员将完全沉浸于其新的躁狂症状。"
        "这是否会被其他人理解（apparent to other people）则取决于守秘人和此调查员。\n"
        "{detail_roll}\n"
        "具体躁狂症: {detail}(KP也可以自行从躁狂症状表中选择其他症状)"
    ),
]
