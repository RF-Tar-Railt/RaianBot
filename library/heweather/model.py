...
class QWeatherConfig(BaseModel):
    ...
    apikey: Optional[str] = Field(default=None, deprecated="建议使用更安全的JWT key")
    ...
    use_jwt: Optional[bool] = Field(default=True, description="是否使用 JWT，默认 True")
    jwt_sub: Optional[str] = Field(default=None, description="JWT sub，即控制台中的项目ID")
    jwt_private_key: Optional[str] = Field(default=None, deprecated="JWT 私钥文本，需要自行生成")

    jwt_kid: Optional[str] = Field(default=None, description="JWT Key ID，即控制台中上传公钥后即可获取")
