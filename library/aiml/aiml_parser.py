...
class AimlHandler(ContentHandler):
    ...
    def _end_element(self, name):
        ...
        if name == "aiml":
            ...
            self._currentPattern = u' '.join(split_chinese(self._currentPattern))
    ...
    def _validate_elem_start(self, name, attr, version):  # noqa
        ...
        required, optional, can_be_parent = self._validInfo[parent]
        non_block_style_condition = (parent == "condition" and not ("name" in parent_attr and "value" in parent_attr))
        if not can_be_parent:
