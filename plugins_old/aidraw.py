...
from library.translate import YoudaoTrans
from plugins.config.aidraw import AIDrawConfig
...
async def tdraw(
    ...
    running.add(id_)
    prompts, negative_prompts = await _handle(prompt.result, r18.result)
    req = {
        "prompt": ",".join(
            [
                "masterpiece",
